...
- **优点：**
  ...
  - **自动化：** Parcel 内置了许多自动化的功能，如自动安装依赖项、自动刷新、自动代码拆分等。这些功能减轻了开发者的负担。
  - **快速启动：** 使用多核处理和文件系统缓存，提供了极快的构建速度。
...
| **自动代码拆分** | ✅                     | ✅                             | ✅                            | ✅                            | ✅                              | ✅                            |
| **插件系统**     | ✅                     | ✅                           | ✅                             | ❌                           | ✅                              | ✅                             |
| **社区支持<br>(stars / issues / pr)** | 63k                 | 61k                           | 23k                         | 23k                         | 19.6k                         | 42.8k                       |
| **是否维护**       | ✅                    | ✅                            | ✅                         | ✅                        | ❌                         | ✅                       |
